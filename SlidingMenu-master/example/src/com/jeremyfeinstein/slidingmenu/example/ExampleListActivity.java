...
import com.jeremyfeinstein.slidingmenu.example.fragments.TestSample;
...
//		Crittercism.init(getApplicationContext(), "508ab27601ed857a20000003");
	...
	public boolean onPreferenceTreeClick(PreferenceScreen screen, Preference pref) {
		...
		} else if (title.equals(getString(R.string.Test))) {
				cls = TestSample.class;
		} else if (title.equals(getString(R.string.EnterUserName))) {
